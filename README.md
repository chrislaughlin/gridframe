...
- **AI-generated Dashboard proposals:** OpenRouter-backed planning selects registered Cards and safe fields, validates a preview, and waits for an explicit revision-gated Apply. See [AI-generated Dashboards](docs/ai-dashboards.md).
